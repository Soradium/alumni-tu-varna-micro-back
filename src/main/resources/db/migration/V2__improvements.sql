...
ALTER TABLE faculties ALTER COLUMN faculty_id ADD GENERATED BY DEFAULT AS IDENTITY;

ALTER TABLE alumni DROP COLUMN degree;

ALTER TABLE alumni ADD COLUMN degree_id INT REFERENCES degrees(degree_id);

ALTER TABLE alumni_groups DROP COLUMN speciality;

ALTER TABLE alumni_groups ADD COLUMN speciality_id INT REFERENCES specialities(id);
